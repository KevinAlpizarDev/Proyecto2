"use"
//IMPRIMIR EL NOMBRE DEL USUARIO EN SU PERFIL
// PARA EL ELEMENTO H1
const elementoPadre = document.querySelector(".nombre"); // Agregar el nodo 
const nombreUsuario = document.createElement("p"); // Tipo de elemento
const textoh1 = document.createTextNode("HOLA"); // Seleccionar elemento padre 
