...
// LOGICA PARA AGREGAR IMAGEN
let emailFormulario; // Variable para almacenar el correo del formulario
...
form.addEventListener('submit', (e) => {
    ...
    // Capturar el valor del correo del formulario en la variable emailFormulario
    emailFormulario = email.value;
    console.log('Correo electrónico de los empleados:', emailFormulario);
